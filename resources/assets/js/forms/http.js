module.exports = {
     ...
     */
    post(uri, form) {
        return Limitless.sendForm('post', uri, form);
    },
     ...
     */
    put(uri, form) {
        return Limitless.sendForm('put', uri, form);
    },
     ...
     */
    patch(uri, form) {
        return Limitless.sendForm('patch', uri, form);
    },
     ...
     */
    delete(uri, form) {
        return Limitless.sendForm('delete', uri, form);
    },
