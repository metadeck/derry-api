...
class CmsGenerateModel extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'cms:generate:model';
    ...
    protected function buildClass($name)
    {
        ...
        $table = str_plural($this->option('table') ?: strtolower($this->getNameInput()));
        ...
        return $this
            ...
            ->replaceRelationships($stub, $relationships)
            ->replaceClass($stub, $name);

    }

    /**
     * Add the relationship functions
     *
     * @param string $stub
     * @return $this
     */
    protected function replaceRelationships(&$stub, $relationships)
    {
        $stub = str_replace(
            '{{relationships}}', $relationships, $stub
        );
    ...
    protected function getOptions()
    {
        return [
            ...
            ['relationships', null, InputOption::VALUE_NONE, 'The relationship functions.', null],
        ];
    }
}
